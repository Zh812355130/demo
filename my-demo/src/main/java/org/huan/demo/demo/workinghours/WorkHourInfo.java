...
public class WorkHourInfo {
    ...
    public static int PERSON_NAME_INDEX = 10;
    public static int PROJECT_NAME_INDEX = 8;
    public static int WORK_HOUR_INDEX = 19;
...
//            choiceDay = RandomUtil.randomEle(new Integer[]{days, days - 1});
    ...
    public void readExcel() throws IOException {
        List<Object> objects = EasyExcel.read(excelPath, new AnalysisEventListener<Map<Integer, String>>() {
            ...
            public void invoke(Map<Integer, String> data, AnalysisContext context) {
                String name = data.get(PERSON_NAME_INDEX);
                String projectName = data.get(PROJECT_NAME_INDEX);
                String workHourPercent = data.get(WORK_HOUR_INDEX);
    ...
    public static void main(String[] args) throws IOException {
        ...
        WorkHourInfo workHourInfo = new WorkHourInfo(path, 6, 0);
